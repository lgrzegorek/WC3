...
<div class="zakladka">
  ...
  <div class="wymagania"><?php oblicz($_SESSION['castle_lvl'],500,500,true)?></div>
    <input type="text" style="width: 30px;">
    <div class="ulepsz" id="upRatusz">
      <?php wypisz(($_SESSION['castle_lvl']+1),500,500,false)?>
    </div>
    <div class="czas"><?php czas(($_SESSION['castle_lvl']+1),60) ?></div>
</div>
<div class="zakladka">
    ...
    <div class="wymagania"><?php oblicz($_SESSION['barrack_lvl'],300,350,true)?></div>
    <input type="text" style="width: 30px;">
    <div class="ulepsz">
          <?php wypisz(($_SESSION['barrack_lvl']+1),500,500,false)?>
    </div>
      <div class="czas"><?php czas(($_SESSION['barrack_lvl']+1),50) ?></div>
</div>
<div class="zakladka">
    ...
    <div class="wymagania"><?php oblicz($_SESSION['altar_lvl'],300,150,true)?></div>
     <input type="text" style="width: 30px;">
    <div class="ulepsz">
        <?php wypisz(($_SESSION['altar_lvl']+1),500,500,false)?>
    </div>
     <div class="czas"><?php czas(($_SESSION['altar_lvl']+1),40) ?></div>
</div>
<div class="zakladka">
    ...
    <div class="opis">
     ...
     <div class="wymagania"><?php oblicz($_SESSION['forge_lvl'],300,300,true)?></div>
     <input type="text" style="width: 30px;">
    <div class="ulepsz">
         <?php wypisz(($_SESSION['forge_lvl']+1),500,500,false)?>
    </div>
    <div class="czas"><?php czas(($_SESSION['forge_lvl']+1),40) ?></div>
</div>
<div class="zakladka">
    ...
    <div class="opis">
     ...
     <div class="wymagania"><?php oblicz($_SESSION['house_lvl'],250,300,true)?></div>
     <input type="text" style="width: 30px;">
    <div class="ulepsz">
         <?php wypisz(($_SESSION['house_lvl']+1),500,500,false)?>
    </div>
     <div class="czas"><?php czas(($_SESSION['house_lvl']+1),50) ?></div>
</div>
<?php
	include ('stopka.php');
?>